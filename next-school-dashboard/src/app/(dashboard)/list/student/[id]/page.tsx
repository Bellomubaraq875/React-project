                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        {[
                            ...
                            { img: "/singleBranch.png", title: "Primary 6", subtitle: "Class" },
                            { img: "/singleLesson.png", title: "16", subtitle: "Lessons" },
                            { img: "/singleClass.png", title: "79%", subtitle: "Score" },
                        ].map((card, index) => (
                            <div
                                key={index}
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4" >
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-wrap text-md text-gray-500">
                        <Link className="p-3 rounded-md bg-pink-200 " href='/'>Student&apos;s Classes</Link>
                        <Link className="p-3 rounded-md bg-purple-200" href='/'>Student&apos;s Students</Link>
                        <Link className="p-3 rounded-md bg-red-200" href='/'>Student&apos;s Lessons </Link>
                        <Link className="p-3 rounded-md bg-amber-200" href='/'>Student&apos;s Exam</Link>
                        <Link className="p-3 rounded-md bg-green-200" href='/'>Student&apos;s Assignments</Link>
                    </div>
                </div>
                <Performance />
                <Announcements />
