                ...
                <div className="mb-8 flex flex-wrap gap-4 items-center justify-between">
                    <div className="flex gap-4 flex-wrap">
                        <input
                            ...
                            className="bg-neutral-900 border border-neutral-800 text-neutral-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500/20 min-w-[200px]"
                        />
                                ...
                                <div className="space-y-4 flex-1">
                                    ...
                                    {report.image && (
                                        <img
                                            src={report.image}
                                            alt="Report"
                                            className="mt-4 rounded-lg border border-neutral-800 max-w-[300px]"
                                        />
                                    )}
                                </div>
                                <select
                ...
                {reports.length > 0 && (
                    <div className="mt-8 flex justify-between items-center">
                        <button
                            ...
                            disabled={page === 1}
                            className="px-4 py-2 text-sm font-medium text-neutral-300 bg-neutral-900 rounded-lg hover:bg-neutral-800 border border-neutral-800 transition-all hover:border-neutral-700 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            Previous
                        </button>
